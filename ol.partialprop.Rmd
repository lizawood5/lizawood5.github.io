---
title: "Proportional and partial-proportional cumulative ordered logits"
...
```{r, warning=F, error=F}
vgam.model.prop = vglm(ordered(interest) ~ acres + income + education + econ.value + envt.value + info.count, data = df, family=cumulative(parallel = T, reverse = T))

vgam.model.nonprop = vglm(ordered(interest) ~ acres + income + education + econ.value + envt.value + info.count,  data = df, family=cumulative(parallel = F, reverse = T))

vgam.model.partialprop = vglm(ordered(interest) ~ acres + income + education + econ.value + envt.value + info.count, data = df, family=cumulative(parallel = F ~ priority_econ, reverse = T))
```
